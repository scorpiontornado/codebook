...
\usepackage[portrait,a4paper,twoside=false,top=15mm,bottom=15mm,left=10mm,right=10mm]{geometry}
...
% \begin{multicols*}{3} % for letter, landscape - fits 60 chars per line
\begin{multicols*}{2} % for a4, portrait - fits 67 chars per line
...
\subsection{Brute force comparison script}
\lstinputlisting[language=sh]{compare.sh}
...
\subsection{Minimum Spanning Tree} % UNSW COMP4128 lecture code
\lstinputlisting[language=c++]{mst.cpp}

\subsection{Dijkstra} % UNSW COMP4128 lecture code
\lstinputlisting[language=c++]{dijkstra.cpp}

\subsection{Bellman-Ford} % UNSW COMP4128 lecture code
\lstinputlisting[language=c++]{bellman-ford.cpp}

\subsection{Floyd-Warshall} % UNSW COMP4128 lecture code
...
\subsection{LCA (Binary Lifting)} % UNSW COMP4128 lecture code
\lstinputlisting[language=c++]{lca.cpp}

\section{Data Structures}

\subsection{Order Statistics Tree (GNU PBDS)} % Nicholas Langford & UNSW COMP4128 lecture code
\lstinputlisting[language=c++]{ost.cpp}

\subsection{Union Find (DSU)} % UNSW COMP4128 lecture code
...
\subsection{Binary search} % Brian Bi & UNSW COMP4128 lecture code
\lstinputlisting[language=c++]{bsearch.cpp}
